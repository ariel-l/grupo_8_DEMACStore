...
CREATE TABLE `orders` (
  ...
  `updatedAt` timestamp NULL DEFAULT NULL,
  `userID` int(11) NOT NULL,
  `finalQuantity` int(20) DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Admin12345678--','Admin','Admin2','admin2@mail.com','Admin12345678--',11111111,'default-image.png',NULL,NULL,'admin',NULL),(2,'User12345678--','User','User2','user2@gmail.com','User12345678--',29365265,'default-image.png',NULL,NULL,'user',NULL),(7,'admin','Admin','Formar','admin@mail.com','$2a$10$slgWzUnv3oYRt2/wCr3mfeCUtgtDuamxZX6IlbE1HNBI4B.DC2/he',1122334455,'1679261776411_avatar_.png',NULL,NULL,'admin',NULL),(8,'user','User','Formar','user@mail.com','$2a$10$yIvbeWwUhPiytFOaJIH3NuXyakKzjgTjLwMT6A7s9ERLHBvSIZkBC',1415138586,'default-image.png',NULL,NULL,'user',NULL),(9,'user',NULL,NULL,'cami@gmail.com','$2a$10$xM1kGCXaeH3aYO6lYFIl8OydcE0VoXweKLNuaETMGH.BJEms90FDa',NULL,'1682813642543_avatar_.pdf','2023-04-30 00:14:02','2023-04-30 00:14:02','user',NULL),(10,'cami',NULL,NULL,'cami.yniguez@gmail.com','$2a$10$CjD5yGY3jZPBQ/CG6i9N7eyLXwn6hrZ043UP.GmjcqNK755.zWcfS',NULL,'1682813769155_avatar_.png','2023-04-30 00:16:09','2023-04-30 00:16:09','user',NULL);
...
-- Dump completed on 2023-06-07 18:12:34
